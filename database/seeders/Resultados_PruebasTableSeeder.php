...
class Resultados_PruebasTableSeeder extends Seeder
{
    /**
    ...
    {
        DB::table('resultados_pruebas')->truncate();
        $resultados_pruebas = [
            [
                'grupo_id' => 1,
                'prueba_id' => 1,
        ...
        foreach ($resultados_pruebas as $resultado) {
            DB::table('resultados_pruebas')->insert($resultado);
        }
    }
}
